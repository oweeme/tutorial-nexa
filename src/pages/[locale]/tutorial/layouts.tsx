    ...
    return (
        <div class="nx-tutorial-layout">
            <nav class="nx-toc">
                ...
                <a class="active" href={`/${params.locale}/tutorial/layouts`}><span class="nx-toc-num">12</span>{t("tutorial.layouts.title")}</a>
            ...
            <section>
                <h2>{t("tutorial.layouts.s3Title")}</h2>
                <pre><code>{t("tutorial.layouts.s3Code")}</code></pre>
