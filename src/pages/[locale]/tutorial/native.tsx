    ...
    return (
        <div class="nx-tutorial-layout">
            <nav class="nx-toc">
                ...
                <a class="active" href={`/${params.locale}/tutorial/native`}><span class="nx-toc-num">16</span>{t("tutorial.native.title")}</a>
            ...
            <section>
                <h2>{t("tutorial.native.s3Title")}</h2>
                <pre><code>{t("tutorial.native.s3Code")}</code></pre>
