    ...
    return (
        <div class="nx-tutorial-layout">
            <nav class="nx-toc">
                ...
                <a class="active" href={`/${params.locale}/tutorial/first-project`}><span class="nx-toc-num">02</span>{t("tutorial.firstProject.title")}</a>
                ...
                <a href={`/${params.locale}/tutorial/production`}><span class="nx-toc-num">16</span>{t("tutorial.production.title")}</a>
            </nav>
